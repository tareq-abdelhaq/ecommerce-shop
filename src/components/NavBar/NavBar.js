      ...
      <nav
        className={
          this.props.darkTheme
            ? `${styles["nav__bar"]} ${styles["dark"]}`
            : styles["nav__bar"]
        }
      >
        {this.props.windowWidth <= 1300 && (
          <li
            className={`${styles["nav__bookmark"]} ${styles["hamburger__icon"]}`}
            onClick={this.props.showSideBar}
          >
            <MenuIcon
              style={{
                color: this.props.darkTheme ? "#d0d2d6" : "#6e6b7b",
                fontSize: "2.4rem",
                cursor: "pointer",
                marginRight: "1.2rem",
              }}
        ...
        <ul
          className={`${styles["nav__bookmarks"]} ${
            this.props.windowWidth <= 992 && styles["hide"]
          }`}
        >
          ...
          <li className={styles["nav__bookmark"]}>
            <a href="#">
              <StarBorderOutlinedIcon
                style={{ color: "#ff9f43", fontSize: "2.4rem" }}
              />
            </a>
          </li>
        </ul>
        <ul
          className={
            this.props.darkTheme
              ? `${styles["nav__admin"]} ${styles["nav__admin__dark"]}`
              : styles["nav__admin"]
          }
        >
          ...
          <li
            className={styles["nav__admin__theme"]}
          ...
          <li className={styles["nav__admin__cart"]}>
            <a href="#">
              ...
              />
              <div
                className={`${styles["nav__notifications"]} ${styles["blue"]}`}
              >
                5
              </div>
            </a>
          ...
          <li className={styles["nav__admin__notifications"]}>
            <a href="#">
              ...
              />
              <div
                className={`${styles["nav__notifications"]} ${styles["red"]}`}
              >
                6
              </div>
            </a>
          ...
          <li className={styles["nav__admin__info"]}>
            <div className={styles["nav__admin__text"]}>
              <p className={styles["dark__text"]}>Tarek Abdelhak</p>
