      ...
      <article
        className={
          this.props.display === "grid"
            ? `${styles["product__card"]} ${styles["grid"]} ${
      ...
      >
        ...
        <div className={styles["product__card__body"]}>
          <div className={styles["product__rating"]}>
            <span className={styles["product__stars"]}>{ratingStars}</span>
            {this.props.display === "grid" && (
          ...
          <h6 className={styles["product__title"]}>
            <a href="#">
              {this.props.name}
              <small>
                {this.props.display !== "grid" && "By "}{" "}
                {this.props.display !== "grid" && (
                  <span className={styles["product__title__brand"]}>
                    {this.props.brand}
                  </span>
                )}
              </small>
